...
<?php
/*
Template Name: Hazooka Showcase Video
*/
?>
<?php get_header(); ?>
    ...
    <?php echo "-->"; ?><article class="grid__item one-whole rh-media hard--left">
      ...
      <div class="showcase-video">
        <div class="video-inner">
          <video width="" height="" class="video-js vjs-default-skin" autoplay data-setup="{}" style="width: 50% !important;margin:auto;display:block;">
            <?php if ( $attachments ) { ?>
